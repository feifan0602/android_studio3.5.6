...
public class CalendarGridViewActivityAdapter extends BaseAdapter {
	private ArrayList<String> list_date;
	private int nowmonth = 0;
	private int nowday = 0;
	private CalenderActivity cf;
	private int pos;
	...
	public CalendarGridViewActivityAdapter(Context context, Resources res,
			CalenderActivity cf) {
