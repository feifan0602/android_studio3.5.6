...
public abstract class TestWebChromeClient extends WebChromeClient {
	private WebChromeClient mWrappedClient;
	private String url;

	protected TestWebChromeClient(WebChromeClient wrappedClient, String url) {
...
//		if (url.contains("/wechatRoom/authTeamUser.do")) {
//			// 资质认证
//			middle_tv.setText("资质认证");
//		} else if (url.contains("/wechatUser/auth.do?")) {
//			// 实名认证
//			middle_tv.setText("实名认证");
//		} else if (url.contains("/wechatUser/preIntegralRule.do")) {
//			// 积分规则
