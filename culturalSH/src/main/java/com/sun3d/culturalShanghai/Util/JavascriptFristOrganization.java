...
public class JavascriptFristOrganization {
	...
	public JavascriptFristOrganization(Activity context) {
		this.context = context;
	}

	public JavascriptFristOrganization(Activity context,
			OrganizationsFragment of) {
		this.context = context;
		this.of_frag = of;
	}
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 1:
				of_frag.middle_tv.setText(msg.obj.toString());
				break;
			case 2:
				// of_frag.right_iv.setVisibility(View.VISIBLE);
				break;
			case 3:
				// of_frag.right_iv.setVisibility(View.GONE);
				break;
			case 4:
				break;
			default:
	...
	public JSONObject getHtmlContentOrImg(int type, String content) {
		if (type == 1) {
			...
			// of_frag.webView.content_text = content;
		} else if (type == 2) {
			// of_frag.webView.img_url = content;
		}
		JSONObject json = new JSONObject();
