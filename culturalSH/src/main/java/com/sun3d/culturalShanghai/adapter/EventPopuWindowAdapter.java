...
public class EventPopuWindowAdapter extends BaseAdapter {
	private ArrayList<EventPopuwindowInfor> list;
	private Context co;

	public EventPopuWindowAdapter(ArrayList<EventPopuwindowInfor> list,
			Context con) {
		this.list = list;
		this.co = con;
	}
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			arg1 = View.inflate(co, R.layout.event_popwindow, null);
...
//		}
		mHodler.mName.setText(list.get(arg0).getName());
		return arg1;
	}
