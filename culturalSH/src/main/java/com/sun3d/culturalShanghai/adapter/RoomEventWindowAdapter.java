...
public class RoomEventWindowAdapter extends BaseAdapter {
	private List<RoomEventInfo> list;
	private Context co;

	public RoomEventWindowAdapter(List<RoomEventInfo> mList,
			Context con) {
		this.list = mList;
		this.co = con;
	}
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			arg1 = View.inflate(co, R.layout.roomevent_popwindow, null);
...
//		}
		Log.i("ceshi", "看看数据===  "+list.get(arg0).getTuserName());
		mHodler.mName.setText(list.get(arg0).getTuserName());
		return arg1;
	}
