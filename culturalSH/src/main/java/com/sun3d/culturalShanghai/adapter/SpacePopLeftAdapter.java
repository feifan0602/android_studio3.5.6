...
import com.sun3d.culturalShanghai.object.Space_Pop_Left_Info;
...
public class SpacePopLeftAdapter extends BaseAdapter {
	private ArrayList<Wff_VenuePopuwindow> mList;
	private Context mContext;
	private ViewHolder vh;

	public SpacePopLeftAdapter(Context context,
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext,
					R.layout.space_pop_item_left_adapter, null);
		...
		vh.tv.setText(mList.get(arg0).getDictName());
		return convertView;
	}
