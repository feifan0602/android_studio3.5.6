...
public class ActivityGoAdapter extends BaseAdapter implements OnTouchListener, OnClickListener {
	...
	public ActivityGoAdapter(Context mContext, List<EventInfo> list, boolean isShowAddress) {
