...
public class RelatedActivityAdapter extends BaseAdapter implements
		OnTouchListener {
	...
	public RelatedActivityAdapter(Context mContext, List<EventInfo> list,
	...
	private View addMainView(final int arg0, View convertView) {
		...
		Log.d("isShowAddress", "111----" + eventInfo.getActivityAbleCount());
