...
public class HomePopuWindowAreaAdapter extends BaseAdapter {
	private ArrayList<Wff_VenuePopuwindow> list;
	private Context co;

	public HomePopuWindowAreaAdapter(ArrayList<Wff_VenuePopuwindow> list,
			Context con) {
		this.list = list;
		this.co = con;
	}
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			arg1 = View.inflate(co, R.layout.home_popwindow_area, null);
