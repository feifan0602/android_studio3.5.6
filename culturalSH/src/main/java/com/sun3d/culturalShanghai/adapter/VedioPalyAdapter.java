...
public class VedioPalyAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			mHolder.iv_adapter_video_thumb = (ImageView) arg1
					.findViewById(R.id.iv_adapter_video_thumb);
			arg1.setTag(mHolder);
		} else {
		...
		MyApplication.getInstance().setImageView(MyApplication.getContext(),
				vi.getVideo_img(), mHolder.iv_adapter_video_thumb);
		...
		widthLayout.width = MyApplication.getWindowWidth() / 3;
