...
import com.sun3d.culturalShanghai.adapter.HomeDetail_ContentAllCityAdapter;
...
public class HomeDetail_Content {
    ...
    public void setData(List<HomeImgInfo> mImgList,
                        List<HomeDetail_ContentInfor> mDataList, boolean ada_bol) {
        ...
        HomeDetail_ContentAllCityAdapter homeDetailContentAllCityAdapter = new
                HomeDetail_ContentAllCityAdapter(mActivity, mDataList);
        if (ada_bol) {
            homedetail_list.setAdapter(ara);
        } else {
            homedetail_list.setAdapter(homeDetailContentAllCityAdapter);
        }
