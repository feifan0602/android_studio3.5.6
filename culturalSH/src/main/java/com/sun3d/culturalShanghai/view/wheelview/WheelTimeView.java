...
public class WheelTimeView extends View {
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFd2d2d2;
	 ...
	 * 上边界和下边界的遮盖高度
	 */
	private static final int topandbottomsize = 200;
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_timeval);
		}
		...
		setBackgroundResource(R.drawable.wheel_timebg);
	}
