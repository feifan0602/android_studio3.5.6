...
/**
 * Created by wangmingming on 2016/1/13 11:33.
 */
public class CustomScrollViewIos extends FrameLayout implements View.OnTouchListener {
    ...
    public CustomScrollViewIos(Context context)
    {
        this(context, null);
    }

    public CustomScrollViewIos(Context context, AttributeSet attrs)
    {

        this(context, attrs, 0);
    }

    public CustomScrollViewIos(Context context, AttributeSet attrs, int defStyle)
    {
