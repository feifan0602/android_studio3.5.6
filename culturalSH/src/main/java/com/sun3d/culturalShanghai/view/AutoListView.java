...
public class AutoListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		footer = inflater.inflate(R.layout.listview_autofooter, null);
		...
		lastUpdate.setText(this.getContext().getString(R.string.lastUpdateTime, "无更新"));
