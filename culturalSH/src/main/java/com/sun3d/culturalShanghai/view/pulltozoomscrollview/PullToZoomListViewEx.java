package com.sun3d.culturalShanghai.view.pulltozoomscrollview;
...
public class PullToZoomListViewEx extends PullToZoomBase<ListView> implements
	...
	/**
	 * 绉婚櫎HeaderView 濡傛灉瑕佸吋瀹笰PI 9,闇�淇敼姝ゅ閫昏緫锛孉PI 11浠ヤ笅涓嶆敮鎸佸姩鎬佹坊鍔爃eader
	 */
	...
	/**
	 * 鏇存柊HeaderView 鍏堢Щ闄�->鍐嶆坊鍔爖oomView銆丠eaderView -->鐒跺悗娣诲姞鍒發istView鐨刪ead
	 * 濡傛灉瑕佸吋瀹笰PI 9,闇�淇敼姝ゅ閫昏緫锛孉PI 11浠ヤ笅涓嶆敮鎸佸姩鎬佹坊鍔爃eader
	 */
	...
	/**
	 * 鍒涘缓listView 濡傛灉瑕佸吋瀹笰PI9,闇�淇敼姝ゅ
	 * 
	 * @param context
	 *            涓婁笅鏂� * @param attrs AttributeSet
	 * @return ListView
	 */
	@Override
			...
			if (mZoomView != null) {
				...
				if ((!mIsFinished) && (mScale > 1.0D)) {
					...
					f2 = mScale - (mScale - 1.0F)
							* PullToZoomListViewEx.sInterpolator.getInterpolation(f1);
