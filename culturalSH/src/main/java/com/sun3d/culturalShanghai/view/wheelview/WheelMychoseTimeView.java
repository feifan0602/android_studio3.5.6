 ...
 */
public class WheelMychoseTimeView extends View {
	/** Scrolling duration */
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF8B969A;
	 ...
	 * 上边界和下边界的遮盖高度
	 */
	private static final int topandbottomsize = 0;
	 ...
	 * Constructor
	 */
	public WheelMychoseTimeView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initData(context);
	}

	public void addPrentView(ScrollView scrollView) {
	 ...
	 * Constructor
	 */
	public WheelMychoseTimeView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelMychoseTimeView(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 */
	private void initResourcesIfNecessary() {// | Paint.FAKE_BOLD_TEXT_FLAG
		if (itemsPaint == null) {
			itemsPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
			// itemsPaint.density = getResources().getDisplayMetrics().density;

			itemsPaint.setTextSize(TEXT_SIZE - 2);
		}
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.wheel_mychoosetimeval);
		}
		...
		setBackgroundResource(R.drawable.wheel_mychoosetimebg);
	}
	...
	private void drawShadows(Canvas canvas) {
		topShadow.setBounds(0, 0, getWidth(), getHeight() / visibleItems + topandbottomsize);
		topShadow.draw(canvas);

		bottomShadow.setBounds(0, getHeight() - getHeight() / visibleItems - topandbottomsize,
				getWidth(), getHeight());
