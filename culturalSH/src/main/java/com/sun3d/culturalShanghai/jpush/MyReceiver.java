...
import com.sun3d.culturalShanghai.Util.ExampleUtil;
import com.sun3d.culturalShanghai.activity.MainFragmentActivity;
import com.sun3d.culturalShanghai.activity.TestActivity;
...
public class MyReceiver extends BroadcastReceiver {
	...
	private void processCustomMessage(Context context, Bundle bundle) {
		...
		if (MainFragmentActivity.isForeground) {
			...
			msgIntent.setAction("com.sun3d.culturalShanghai.MESSAGE_RECEIVED_ACTION");
